...
usage()
{
    echo "Usage: runs the distributional regularizers experiment with a Gamma distribution using the specified"\
...
do
    ...
    -reg_factor $RF -beta $BETA -use_gamma -v -run_number $i -env $ENV
done
