...
#SBATCH --job-name=l2w_small
#SBATCH --output=./outputs/l2w_small-%A_%a.out
...
do
    ...
    python3 ./Regularization_Experiment.py -env $ENV -weights_reg -small_network -run_number $RUN_NUMBER  \
