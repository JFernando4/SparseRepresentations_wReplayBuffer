...
-beta $BETA -reg_factor $RF -env catcher -l1_reg -run_number $RUN1
python3 ./Regularization_Experiment.py -buffer_size $BUFFER -tnet_update_freq $FREQ -lr $LR \
-beta $BETA -reg_factor $RF -env catcher -l1_reg -run_number $RUN2
python3 ./Regularization_Experiment.py -buffer_size $BUFFER -tnet_update_freq $FREQ -lr $LR \
-beta $BETA -reg_factor $RF -env catcher -l1_reg -run_number $RUN3
deactivate
