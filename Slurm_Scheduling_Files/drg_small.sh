...
#SBATCH --job-name=drg_small
#SBATCH --output=./outputs/drg_small-%A_%a.out
...
do
    ...
    python3 ./DistritbutionalReg_Experiment.py -env $ENV -small_network -use_gamma -run_number $RUN_NUMBER \
